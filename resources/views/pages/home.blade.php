        ...
        <div class="mx-auto container grid sm:grid-cols-2 md:grid-cols-2 gap-4 items-center justify-center">
            ...
            <div class="order-1 md:order-2">
                ...
                <div class="lg:flex lg:flex-1 lg:justify-start mt-5">
                    <button class="bg-black px-6 py-3 text-white animation-primary">
                        <div class="circle"></div>
                        <a href="#" class="flex items-center">
                            <p class="mr-2 text-xs tracking-widest">VER MÁS</p>
    ...
    <section id="cobertura" class="mx-auto max-w-7xl py-4 lg:py-0 lg:mt-10 px-6 xl:px-0">
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 items-center justify-center">
            ...
            <div class="order-1 md:w-full md:order-1 md:col-span-2 lg:col-span-1 lg:order-2 text-center">
                ...
                <div class="lg:flex lg:flex-1 lg:justify-start mt-5">
                    <button class="bg-black px-6 py-3 text-white animation-primary mx-auto">
                        <div class="circle"></div>
                        <a href="#" class="flex items-center">
                            <p class="mr-2 text-xs tracking-widest">
