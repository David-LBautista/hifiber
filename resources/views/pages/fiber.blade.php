        ...
        <div class="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8" style="cursor: auto;">
          <div class="max-w-lg mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-none lg:flex">
            <div class="flex-1 px-6 py-8 bg-white lg:p-12" style="cursor: auto;">
              <h3 class="text-2xl font-extrabold text-gray-900 sm:text-3xl" style="cursor: auto;">Acceso Premium a Internet</h3>
              <p class="mt-6 text-base text-gray-500">Explora la revolución de la conectividad con nuestra oferta de fibra óptica con planes desde 30 Megas. Navega a velocidades ultra rápidas y disfruta de una conexión estable y confiable para tus necesidades digitales. Con nuestra tecnología de vanguardia, tendrás acceso a una experiencia en línea sin interrupciones y sin límites. Desde streaming fluido hasta videoconferencias sin interrupciones, nuestra fibra óptica te ofrece todo lo que necesitas para estar siempre conectado. <br> ¡Haz de la velocidad y la fiabilidad una parte integral de tu experiencia en línea hoy mismo!.</p>
            </div>
            <div class="px-6 py-8 text-center bg-gray-50 lg:flex-shrink-0 mr-2 lg:flex lg:flex-col lg:justify-center lg:p-12" style="cursor: auto;">
              ...
              <div class="mt-6">
                <div class="bg-black px-6 py-3 text-white text-xs tracking-widest animation-primary" onclick="window.location.href='https://wa.me/8131011770'; return false;">
                    <div class="circle"></div>
                    <a href="#contacto">OBTENER</a>
                </div>
              </div>
              <div class="mt-4 text-sm">
                <a class="font-medium text-gray-700 hover:text-gray-900" target="_blank">Precio sujeto a cambios.
                </a>
              </div>
            </div>
          </div>
