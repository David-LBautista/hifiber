...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/system/fonts.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/system/style.bundle.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/system/app.css') }}">

    <script src="{{ asset('assets/js/system/app.js') }}"></script>
    <script src="{{ asset('assets/js/system/plugins.bundle.js') }}"></script>
    <script src="{{ asset('assets/js/system/scripts.bundle.js') }}"></script>
    <script src="{{ asset('assets/js/system/widgets.js') }}"></script>
                        ...
                        <div class=" container  d-flex align-items-center justify-content-between"
                            ...
                            <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                                ...
                                <div class="btn btn-icon btn-active-icon-primary" id="kt_aside_toggle">
                                    ...
                                    <span class="svg-icon svg-icon-1 mt-1"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <!--begin::Logo-->
                                <a href="https://belive.test/dashboard" class="d-flex align-items-center">
                                    <img alt="Logo" src="{{ asset('assets/img/hifiber_logo.png') }}"
                                        class="h-50px theme-light-show">
                                    <img alt="Logo" src="{{ asset('assets/img/hifiber_logo.png') }}"
                                        class="h-50px logo theme-dark-show">
                                </a>
                                <!--end::Logo-->
                            </div>
                            <!--end::Wrapper-->
                            ...
                            <div class="d-flex align-items-center flex-shrink-0">
                                {{-- <a href="javascript:;"
                                    class="btn ms-3 ms-lg-4 btn-active-icon-primary btn-outline  me-n2">
                                ...
                                <div class="d-flex align-items-center ms-3 ms-lg-4">
                                    <a href="#"
                                        class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline w-40px h-40px pl-5"
                                        data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                        data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        <!--begin::Svg Icon | path: -->
                                        <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen060.svg-->
                                        <span class="svg-icon svg-icon-1 theme-light-show"><svg
                                        ...
                                        <span class="svg-icon svg-icon-1 theme-dark-show"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
                                                <path
