            ...
            <div class="col-md-8">
                <div class="card card-stretch mb-5 mb-xl-8">
                    <div class="card-header">
                      ...
                      <a href="{{ route('serviceplans.show') }}" class="btn btn-success" style="float: right;">
                        Agregar Plan
                      </a>
                    </div>
